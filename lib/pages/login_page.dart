        ...
        if (user != null) {
          _userRef.child(user.uid).update(<String, String>{
            ...
            Navigator.pushReplacement(context,
                    CupertinoPageRoute(builder: (context) => AllUsersPage()))
                .whenComplete(() {
              setState(() {
                _isLoading = false;
              });
          ...
          children: <Widget>[
            Padding(
              padding: EdgeInsets.only(
                  left: _width / 8, top: 10.0, right: _width / 8),
              child: inputBox(context, _emailController,
            ...
            Padding(
              padding: EdgeInsets.only(
                  left: _width / 8, top: 10.0, right: _width / 8),
              child: inputBox(
                  context, _passwordController, TextInputType.text, "Password"),
            ),
            Padding(
              padding: EdgeInsets.only(
                  left: _width / 5, top: 10.0, right: _width / 5),
